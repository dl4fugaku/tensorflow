...
##            "https://github.com/intel/mkl-dnn/archive/v1.0.2.tar.gz",
##            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/intel/mkl-dnn/archive/v1.0.2.tar.gz",
#        ],
#    )
